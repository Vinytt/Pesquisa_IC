...
def crop_to_hint(image_file):
    ...
    nome_imagem = str(image_file) + '_crop.jpg'

    im = Image.open( path +  image_file)
    im2 = im.crop([vects[0].x, vects[0].y,
                  vects[2].x - 1, vects[2].y - 1])
    im2.save(r'C:\Users\vinic\OneDrive\Imagens\prints_analises\Dicas_Corte\' + nome_imagem', 'JPEG')
    print('Saved new image to ' + nome_imagem)
    print("\n\n")
...
if __name__ == '__main__':
    ...
    for arq in os.listdir(r"C:\Users\vinic\OneDrive\Documentos\Pesquisa\Python\Download_Imagens_Instagram\marielle_50000"):
        if(arq.endswith(".jpg") or arq.endswith(".png")):
            print("Dicas de Corte: " + str(arq) + "\n")
            draw_hint(arq)
